...
<div style="text-align: right; width: 300px;">
  <img id="thesisImage" src="/images/dheeraj_defence_pic.png" alt="Thesis defense" style="width:100%; cursor: pointer;" onclick="toggleImage()" />
</div>

<script>
  function toggleImage() {
    const img = document.getElementById("thesisImage");
    if (img.src.includes("dheeraj_defence_pic.png")) {
      img.src = "/images/thesis_result.png";
    } else {
      img.src = "/images/dheeraj_defence_pic.png";
    }
  }
</script>
